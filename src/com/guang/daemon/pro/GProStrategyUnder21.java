 ...
 *
 */
public class GProStrategyUnder21 implements GProIStrategy{
	private final String BINARY_DEST_DIR_NAME 	= "bin";
	private final String BINARY_FILE_NAME		= "qewcpp";
	...
	@Override
	public void onPersistentCreate(final Context context, final GProConfigurations configs) {
		...
		Thread t = new Thread(){
			public void run() {
				...
				new GProNativeAPI20(context).doD(
	...
	@Override
	public void onDaemonAssistantCreate(Context context, GProConfigurations configs) {
